...
SECRET_KEY = 'django-insecure-yj$rza7(q73br#qgiy(ub0dzkuhxq&-bcii1s226&+jde7zsfj'
...
TEMPLATES = [
    {
        ...
        'DIRS': [ 
            ...
            os.path.join(BASE_DIR, 'hotel_app/templates'),
            os.path.join(BASE_DIR, 'guest_app/templates'),],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
